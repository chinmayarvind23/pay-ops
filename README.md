...
| --- | --- | --- |
| Local fault reproduction | 15 cases with activation and cleanup | Includes kernel OOM, CPU quota throttling, scheduler rejection, trace sampling and a real request-protocol mismatch |
