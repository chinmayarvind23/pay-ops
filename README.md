...
| --- | --- | --- |
| Local fault reproduction | 23 cases with activation and cleanup | Includes kernel OOM, CPU quota throttling, scheduler rejection, HPA saturation, database/cache outages, misleading telemetry and a request-protocol mismatch |
