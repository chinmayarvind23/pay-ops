...
| --- | --- | --- |
| Local fault reproduction | 13 cases with activation and cleanup | Includes kernel OOM, scheduler rejection, trace sampling and a real request-protocol mismatch |
