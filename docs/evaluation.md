...
source, test, lock and runner hashes. The suite has 64 specific schema/evidence/metric/graph/policy
...
Executor mutations will be added with its implementation.
