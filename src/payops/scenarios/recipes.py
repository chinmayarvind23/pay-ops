...
VARIANTS: dict[CaseId, str] = {
    "SCHED-04": "isolated kubelet memory eviction under calibrated reserve; no host exhaustion",
    "TELEM-01": "processor outage and recovery while independent measured CPU noise persists",
